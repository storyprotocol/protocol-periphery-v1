...
contract StoryProtocolGateway is IStoryProtocolGateway, ERC721Holder, AccessManagedUpgradeable, UUPSUpgradeable {
    ...
    function mintAndRegisterIp(
        ...
        _setMetadata(metadata.ipMetadataURI, metadata.ipMetadataHash, metadata.nftMetadataHash, ipId);
    ...
    /// @param nftMetadataHash The hash of the metadata for the NFT.
    /// @param ipId The ID of the IP.
    function _setMetadata(
        ...
        if (
            ...
            CORE_METADATA_MODULE.setAll(ipId, ipMetadataURI, ipMetadataHash, nftMetadataHash);
        }
    }
    ...
    function _setMetadataWithSig(
        ...
        _setMetadata(ipMetadata.ipMetadataURI, ipMetadata.ipMetadataHash, ipMetadata.nftMetadataHash, ipId);
    }
