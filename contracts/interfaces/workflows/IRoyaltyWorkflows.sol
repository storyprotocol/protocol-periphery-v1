...
interface IRoyaltyWorkflows {
    ...
    /// @notice Transfers royalties from royalty policy to the pareancestornt IP's royalty vault, takes a snapshot,
    ...
    /// @param royaltyClaimDetails The details of the royalty claim from child IPs, see {RoyaltyClaimDetails}.
